    ...
    if (data === 'process_4k_ai') {
        ...
        try {
            ...
            try {
                ...
                enhancementPrompt = await (0, geminiService_1.generateEnhancementPrompt)(base64string, 'image/jpeg');
            ...
            const output = await replicate.run(process.env.REPLICATE_AI_MODEL_ID, { input });
            ...
            if (!outputResponse.ok)
                throw new Error('api_download_failed');
