...
function analyzeAndEnhancePrompt(userRawPrompt) {
    ...
    const enhancedPrompt = [
        ...
        '',
        // ── DISABLED: Pollinations image protocol (caused broken base64 in PDFs) ──
        ...
        '',
        `RULE 2 — LAYOUT EFFICIENCY (CRITICAL):`,
        `Every section MUST be dense and complete. NEVER leave a section with only 1-3 lines.`,
        `If a section has less than 4 lines of content → MERGE it with the next section or EXPAND it.`,
        `NEVER create a heading followed by only 1-2 short sentences. Minimum 4-6 sentences per section.`,
        `Page breaks should happen at natural content boundaries, NOT in the middle of thin content.`,
        '',
