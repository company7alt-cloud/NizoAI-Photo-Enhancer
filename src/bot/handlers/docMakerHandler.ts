    ...
    await ctx.editMessageCaption({
      ...
      reply_markup: {
        inline_keyboard: [
          ...
          // @ts-ignore
          [{ text: '🎨 Modern Pro (مودرن برو)', callback_data: 'doc_font_ando_warn', style: 'primary' as const }],
  ...
  if (data.startsWith('doc_font_')) {
    ...
    if (data === 'doc_font_ando_warn') {
      ...
      await ctx.editMessageCaption({
        ...
        reply_markup: {
          inline_keyboard: [
            [{ text: '✅ مواصلة بخط مودرن برو', callback_data: 'doc_font_ando_pro', style: 'success' as const }],
            [{ text: '🔙 اختيار خط آخر', callback_data: 'doc_tpl_confirm', style: 'danger' as const }],
          ],
        },
...
〰️ <b>تخطي سطر واحد:</b> أرسل نقطة  .
〰️ <b>تخطي سطرين:</b> أرسل نقطتين  ..
〰️ <b>تخطي ثلاثة:</b> أرسل ثلاث نقاط  ...
😀 <b>الإيموجي والرموز:</b> مدعومة بالكامل ✅

📌 <b>يمكنك إرسال النص كاملاً دفعة واحدة</b> — سيُطبَّق التنسيق الذي تختاره على كامل النص حتى لو تجاوز أكثر من صفحة.
