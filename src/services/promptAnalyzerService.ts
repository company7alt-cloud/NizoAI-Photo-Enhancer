...
export function buildEnterprisePrompt(
  ...
  const systemPrompt = [
    ...
    'CRITICAL IMAGE RULE: To insert images, you MUST use exactly this format: [IMAGE: english_search_keyword]',
    'Example: [IMAGE: modern corporate office]',
    'DO NOT write Arabic placeholders like "(صورة: ...)". ONLY use the [IMAGE: keyword] format.',
    'When the topic benefits from a visual aid (medical diagram, chart, logo, anatomical illustration, infographic), embed ONE relevant image using this EXACT format on its own line:',
    '[IMAGE: descriptive english keyword]',
    'Examples:',
    '[IMAGE: human heart anatomy medical diagram]',
    '[IMAGE: nike logo minimalist vector]',
    '[IMAGE: professional business chart infographic]',
    'Use maximum 2 images per document. Only add when genuinely relevant.',
    'NEVER write placeholder text like (أدخل صورة هنا) or (صورة: ...). Use [IMAGE:] tag instead.',
    '',
    '=== AUTO DETECTION ===',
